...
CREATE TABLE [dbo].[G_Lnk_Create_DirectJournal](
...
CREATE TABLE [dbo].[G_Lnk_Build_DetailJournal](
...
--GenerateDirectJournal 1,'Inv',157
 ALTER PROCEDURE dbo.G_GenerateDirectJournal
    @CompCode INT,
    @KeyTrans NVARCHAR(200),
    @TranID INT
AS
...
Go
 ...
 ALTER PROCEDURE [dbo].[G_Create_JournalStyle]
    @CompCode INT, 
...
BEGIN
    ...
    BEGIN
        ...
        SET @DynamicSQL = N'
            ...
            WHILE @@FETCH_STATUS = 0
            BEGIN
                EXEC G_GenerateDirectJournal ' + CAST(@CompCode AS NVARCHAR) + ', ''' + @CurrKeyTrans + ''', @TransIDFromCursor;
                FETCH NEXT FROM cursorTransID INTO @TransIDFromCursor;
            END
...
END
  ...
  INSERT INTO G_Lnk_Create_DirectJournal (
    ID_Lnk,
    CompCode,
    KeyTrans,
    NameTableMaster,
...
VALUES 
(1, 1, 'Inv', 'I_TR_Sales', 'SaleID', 'SaleDate', 'TrType', 1),
(2, 1, 'Pur', 'I_TR_Purchases', 'PurchaseID', 'PurDate', 'TrType', 1);
...
INSERT INTO G_Lnk_BuildDirectJournal (
    ID_Build,
    CompCode,
    KeyTrans,
    DescA_FelidLnk,
...
VALUES
(1, 1, 'Inv', N'الصندوق', 0, NULL, NULL, NULL, 'VoucherNo', 'NetAmount', 1, 'Remarks', 1),
(2, 1, 'Inv', N'العميل', 1, 'CustomerID', 'A_Rec_D_Customer', 'CustomerID', 'AccountNo', 'NetAmount', 0, 'Remarks', 1),
(3, 1, 'Inv', N'الضريبه', 0, NULL, NULL, NULL, 'VoucherNo', 'VatAmount', 1, 'Remarks', 1),
(4, 1, 'Inv', N'حساب الضريبه المضافه', 1, 'VatTypeID', 'D_A_VatType', 'VatTypeID', 'Type', 'VatAmount', 0, 'Remarks', 1),
(5, 1, 'Inv', N'تجربة الاكسبراشن', 1, 'VatTypeID', 'D_A_VatType', 'VatTypeID', 'Type', '( ISNULL(NetAmount , 0) + ISNULL(VatAmount , 0))', 1, '''تجربه '' + Remarks', 0),
(6, 1, 'Pur', N'الصندوق', 0, NULL, NULL, NULL, 'VoucherNo', 'NetAmount', 1, 'Remarks', 1),
(7, 1, 'Pur', N'العميل', 1, 'SupplierID', 'D_A_Suppliers', 'SupplierID', 'SuppliersCode', 'NetAmount', 0, 'Remarks', 1),
(8, 1, 'Pur', N'الضريبه', 0, NULL, NULL, NULL, 'VoucherNo', 'VatAmount', 1, 'Remarks', 1),
(9, 1, 'Pur', N'حساب الضريبه المضافه', 1, 'VatTypeID', 'D_A_VatType', 'VatTypeID', 'Type', 'VatAmount', 0, 'Remarks', 1);
