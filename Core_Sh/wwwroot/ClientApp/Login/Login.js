...
(function (Login) {
    ...
    var Reg_Comp_Name;
    var Usr_DlevType;
    var Reg_FrontDLic_Img;
    var Reg_BackDLic_Img;
    var Reg_FrontCLic_Img;
    var Reg_BackCLic_Img;
    var btnForgot_Password;
    ...
    function InitalizeControls() {
        Send_Reset_Link = document.getElementById("Send_Reset_Link");
        btnForgot_Password = document.getElementById("btnForgot_Password");
        btnUpdatePassword = document.getElementById("btnUpdatePassword");
        LoginOpenComp = document.getElementById("LoginOpenComp");
        ...
        dbCompany = document.getElementById("dbCompany");
        Reg_Comp_Name = document.getElementById("Reg_Comp_Name");
        Reg_Work_Zone = document.getElementById("Reg_Work_Zone");
        Reg_FamilyZone = document.getElementById('Reg_FamilyZone');
        dbyear = document.getElementById('dbyear');
        Usr_DlevType = document.getElementById("Usr_DlevType");
        Reg_FrontDLic_Img = document.getElementById("Reg_FrontDLic_Img");
        Reg_BackDLic_Img = document.getElementById("Reg_BackDLic_Img");
        Reg_FrontCLic_Img = document.getElementById("Reg_FrontCLic_Img");
        Reg_BackCLic_Img = document.getElementById("Reg_BackCLic_Img");
    }
    ...
    function GetData_Header() {
        ...
        if (_Device.length > 0) {
            ...
            if (USER.length > 0) {
                ...
                $('#dbCompany').change();
                if (((_a = _Device[0].FIN_YEAR) !== null && _a !== void 0 ? _a : 0) > 0) {
    ...
    function GetUserByCode(USER_CODE, PASSWORD, isReg) {
        let con = "";
        ...
        DataResult(Table);
        let USERS = GetDataTable('IQ_G_RoleUsersComp');
        if (USERS.length == 0) {
            var Table;
            Table =
                [
            ...
            DataResult(Table);
            USERS = GetDataTable('IQ_G_RoleUsersComp');
        }
        return USERS;
    }
    function GetDataGQ_USERS(IdUser) {
    ...
    function OpenAdminCompany(USER_CODE, PASSWORD) {
        var today = new Date();
        var mm1 = (today.getMinutes() + 1).toString();
        var mm2 = (today.getMinutes() + 2).toString();
    ...
    function SetRoleAndcookie(USER) {
        debugger;
