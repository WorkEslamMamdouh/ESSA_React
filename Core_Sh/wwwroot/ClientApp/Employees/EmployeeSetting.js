$(document).ready(() => {
    EmployeeSetting.InitalizeComponent();
});
var EmployeeSetting;
(function (EmployeeSetting) {
    ...
    EmployeeSetting.InitalizeComponent = InitalizeComponent;
    ...
    function ViewEmpType(item) {
        ...
        SetModelGlopel(item);
        OpenPagePartial("EditEmployeeSetting", "Edit Employee ", () => { Display_Refrsh(); });
    }
...
//# sourceMappingURL=EmployeeSetting.js.map