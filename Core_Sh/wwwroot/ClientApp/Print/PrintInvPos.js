...
(function (PrintInvPos) {
    ...
    PrintInvPos.InitalizeComponent = InitalizeComponent;
    ...
    function Create_Invoice_Print(_IQ_TR_Sales, _IQ_TR_SaleDetails) {
        ...
        if (_IQ_TR_Sales.CustomerID != null) {
            ...
            if (_IQ_TR_Sales.InvoiceTransCode == 1) {
                let CustomerData = GetDataFrom("D_Customer", 'CustomerId = ' + _IQ_TR_Sales.CustomerID + '');
...
})(PrintInvPos || (PrintInvPos = {}));
//# sourceMappingURL=PrintInvPos.js.map