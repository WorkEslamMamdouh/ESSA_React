...
(function (Report_Page) {
    ...
    function InitalizeComponent() {
        ...
        succes = localStorage.getItem(GetParameterByName('App') + "result");
        InitalizeControls();
        InitalizeEvents();
        GetReport();
        //result = localStorage.getItem(GetParameterByName('App') + "result");
        //GetHtml(succes);
    }
        ...
        if (ReportData != null) {
            ...
            Ajax.CallAsync({
                ...
                success: function (d) {
                    ...
                    var Model = localStorage.getItem(GetParameterByName('App') + "Model_Screen");
                    setTimeout(function () {
