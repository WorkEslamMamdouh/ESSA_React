...
(function (Edit_Order) {
    ...
    function Assign() {
        ...
        Header.TrDate = DateFormatddmmyyyy($('#Txt__TrData').val());
        Header.DeliveryDate = DateFormatddmmyyyy($('#Txt_Receive_TrData').val());
    ...
    function Update() {
        ...
        try {
            Ajax.CallsyncSave({
                ...
                data: { DataSend: JSON.stringify(InvMasterDetails) },
                success: function (d) {
                     ;
                    var result = d;
                    if (result.IsSuccess) {
