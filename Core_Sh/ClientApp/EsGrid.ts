...
class ESG {
    ...
    public OnRowRunFunction?: () => void;
    public OnEditGridRunFunction?: () => void;
    public OnAddNewRowRunFunction?: () => void;
...
interface String {
    ...
    Get_ID: (Grid: ESGrid) => string;
    Get_Cheak: (Grid: ESGrid) => boolean;
    Get_Num: (Grid: ESGrid) => number;
    Get_Val: (Grid: ESGrid) => string;
    Set_Val: (value: string, Grid: ESGrid) => string;
    Set_Val_From_localStor: (Key: string, Grid: ESGrid) => string;
    html: (value: string, Grid: ESGrid) => string;
    append: (value: string, Grid: ESGrid) => string;
    Add_Attr: (NameAttr: string, value: string, Grid: ESGrid) => string;
    Add_Class: (value: string, Grid: ESGrid) => string;
    RemoveClass: (value: string, Grid: ESGrid) => string;
    RemoveAttr: (value: string, Grid: ESGrid) => string;


    Get_IDInRow: (Grid: ESGrid) => string;
    Get_CheakInRow: (Grid: ESGrid) => boolean;
    Get_NumInRow: (Grid: ESGrid) => number;
    Get_ValInRow: (Grid: ESGrid) => string;
    Set_ValInRow: (value: string, Grid: ESGrid) => string;
    htmlInRow: (value: string, Grid: ESGrid) => string;
    appendInRow: (value: string, Grid: ESGrid) => string;
    Add_AttrInRow: (NameAttr: string, value: string, Grid: ESGrid) => string;
    Add_ClassInRow: (value: string, Grid: ESGrid) => string;
    RemoveClassInRow: (value: string, Grid: ESGrid) => string;
    RemoveAttrInRow: (value: string, Grid: ESGrid) => string;


    Get_StatusFlag: (Grid: ESGrid) => string;
    G_F_ID: (Grid: ESGrid) => string;
    G_F_Cheak: (Grid: ESGrid) => boolean;
    G_F_Num: (Grid: ESGrid) => number;
    G_F_Val: (Grid: ESGrid) => string;
    S_F_Val: (value: string, Grid: ESGrid) => string;
    F_Html: (value: string, Grid: ESGrid) => string;
    F_Change: (Grid: ESGrid) => string;
    F_append: (value: string, Grid: ESGrid) => string;
    Add_F_Attr: (NameAttr: string, value: string, Grid: ESGrid) => string;
    Add_F_Class: (value: string, Grid: ESGrid) => string;
    F_RemoveClass: (value: string, Grid: ESGrid) => string;
    F_RemoveAttr: (value: string, Grid: ESGrid) => string;
}


var Valid = {

    Set: function (valid: boolean, Mess?: string, SetConation?: string): Valid_Con {
...
namespace ControlType {
    ...
    String.prototype.Get_ID = function (Grid: ESGrid): string {
        let NameFild = this;
    ...
    String.prototype.Set_Val_From_localStor = function (Key: any, Grid: ESGrid): any {
        let NameFild = this;
    ...
    String.prototype.Add_Attr = function (NameAttr: any, value: any, Grid: ESGrid): any {
        let NameFild = this;
        $('#' + Grid.ESG.NameTable + '_' + NameFild + Grid.ESG.RowCnt + '').attr(NameAttr, value)
        return (value);
    };
    String.prototype.RemoveAttr = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        $('#' + Grid.ESG.NameTable + '_' + NameFild + Grid.ESG.RowCnt + '').removeAttr(value)
        return (value);
    };
    String.prototype.Add_Class = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        $('#' + Grid.ESG.NameTable + '_' + NameFild + Grid.ESG.RowCnt + '').addClass(value)
        return (value);
    };
    String.prototype.RemoveClass = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
    ...
    String.prototype.Get_IDInRow = function (Grid: ESGrid): string {
        let NameFild = this;
        let RowCnt = localStorage.getItem('RowCnt');
        let value = '' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + ''
        return (value);
    };
    String.prototype.Get_ValInRow = function (Grid: ESGrid): string {
        let NameFild = this;
        let RowCnt = localStorage.getItem('RowCnt');
        let value = $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').val()
        return (value);
    };
    String.prototype.Set_ValInRow = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = localStorage.getItem('RowCnt');
        if (value == true || value == false) {
    ...
    String.prototype.Get_NumInRow = function (Grid: ESGrid): number {
        let NameFild = this;
        let RowCnt = localStorage.getItem('RowCnt');
        let value = $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').val()
        return (Number(value));
    };
    String.prototype.Get_CheakInRow = function (Grid: ESGrid): boolean {

        let NameFild = this;
        let RowCnt = localStorage.getItem('RowCnt');
        let value: boolean = $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').is(":checked")
        return (value);
    };
    String.prototype.htmlInRow = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = localStorage.getItem('RowCnt');
    ...
    String.prototype.appendInRow = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = localStorage.getItem('RowCnt');
    ...
    String.prototype.Add_AttrInRow = function (NameAttr: any, value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = localStorage.getItem('RowCnt');
        $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').attr(NameAttr, value)
        return (value);
    };
    String.prototype.RemoveAttrInRow = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = localStorage.getItem('RowCnt');
        $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').removeAttr(value)
        return (value);
    };
    String.prototype.Add_ClassInRow = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = localStorage.getItem('RowCnt');
        $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').addClass(value)
        return (value);
    };
    String.prototype.RemoveClassInRow = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = localStorage.getItem('RowCnt');
    ...
    String.prototype.G_F_ID = function (Grid: ESGrid): string {
        let NameFild = this;
        let RowCnt = Grid.ESG.RowCnt
        let value = '' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + ''
        return (value);
    };
    String.prototype.G_F_Cheak = function (Grid: ESGrid): boolean {
    ...
    String.prototype.Get_StatusFlag = function (Grid: ESGrid): string {
        let NameFild = this;
        let RowCnt = Grid.ESG.UnCnt
        let value = $('#' + NameFild +'_' + Grid.ESG.NameTable + '_'+ RowCnt + '').val()
        return (value);
    };     
    String.prototype.G_F_Val = function (Grid: ESGrid): string {
        let NameFild = this;
        let RowCnt = Grid.ESG.RowCnt
        let value = $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').val()
        return (value);
    };
    String.prototype.S_F_Val = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = Grid.ESG.RowCnt
        if (value == true || value == false) {
    ...
    String.prototype.G_F_Num = function (Grid: ESGrid): number {
        let NameFild = this;
        let RowCnt = Grid.ESG.RowCnt
        let value = $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').val()
        return (Number(value));
    ...
    String.prototype.F_Html = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = Grid.ESG.RowCnt
        $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').html(value)
    ...
    String.prototype.F_Change = function (Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = Grid.ESG.RowCnt
        $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').change();
        return ("");
    };
    String.prototype.F_append = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = Grid.ESG.RowCnt
        $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').append(value)
    ...
    String.prototype.Add_F_Attr = function (NameAttr: any, value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = Grid.ESG.RowCnt
        $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').attr(NameAttr, value)
        return (value);
    };
    String.prototype.F_RemoveAttr = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = Grid.ESG.RowCnt
        $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').removeAttr(value)
        return (value);
    };
    String.prototype.Add_F_Class = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = Grid.ESG.RowCnt
        $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').addClass(value)
        return (value);
    };
    String.prototype.F_RemoveClass = function (value: any, Grid: ESGrid): any {
        let NameFild = this;
        let RowCnt = Grid.ESG.RowCnt
        $('#' + Grid.ESG.NameTable + '_' + NameFild + RowCnt + '').removeClass(value)
        return (value);
    ...
    export function Dropdown(dataSourc: Array<any>, Value: string,textField: string, NameDefult?: string, onchange?: () => void, onkeyup?: () => void, onclick?: () => void): ControlEvents {
...
function SaveGridControl(Grid: ESGrid) {
    $('#btnsave_' + Grid.ESG.NameTable).click();

}

function ClearGridControl(Grid: ESGrid) {
...
function RowDisplayRunFunction(List: Array<any>, Grid) {
...
function EditRowDisplayRunFunction(Grid: ESGrid) {
...
function BuildGridControl(flagDisplay: boolean, Grid: ESGrid) {
    ...
    for (let u = 0; u < Grid.Column.length; u++) {
        ...
        if (Grid.Column[u].ColumnType.NameType == 'Dropdown') {
            ...
            $('#No_Row_' + NameTable + cnt + '').append(td);
            let ddlFilter: HTMLSelectElement = document.getElementById('' + NameTable + '_' + Grid.Column[u].ID + cnt + '') as HTMLSelectElement;
...
function DeleteRow(Grid, ID: string, cnt: number, NameTable: string) {
...
function ErrorinputGrid(input: any, NameTable: string, MessAr: string) {
...
function SafeEval(Conation: string, element: HTMLInputElement): boolean {
    try {
        if (Conation.trim() === "") return false;
    ...
    for (var i = 0; i < LastCountGrid; i++) {
        ...
        if (StatusFlag != "d" && StatusFlag != "m") {
            ...
            for (var u = 0; u < obj.length; u++) {
                ...
                let element = document.getElementById('' + NameTable + '_' + Model.ID + cnt) as HTMLInputElement;
...
function CrealConation(Conation: string, NameTable: string, cnt: number) {
    // Given string
    ...
    for (var i = 0; i < matches.length; i++) {
        let ID: string = matches[i]
        ID = ID.replace(/#/g, '');

        let element = document.getElementById('' + NameTable + '_' + ID + cnt) as HTMLInputElement;
        try {
...
function CopyRow(Grid: ESGrid, index: number) {
    ...
    let ListCopyModel: Array<any> = new Array<any>();
...
function BuildCopy(_Column: Array<Column>, Grid: ESGrid, List: any, cnt: number) {
    ...
    for (var property of properties) {
        ...
        if (col.length > 0) {
            ...
            let element = document.getElementById('' + NameTable + '_' + col[0].ID + cnt) as HTMLInputElement;
...
var GActions = {
    ...
    AssignToModel: <T>(_Column: Array<Column>, Model: T, NameTable: string, cnt: number, StatusFlag: string): T => {
    ...
    ComputeTotalToModel: <T>(_Column: Array<Column>, Model: T, NameTable: string, cnt: number, StatusFlag: string): T => {
