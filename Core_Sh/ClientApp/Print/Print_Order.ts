...
//        InvoiceID = Number(localStorage.getItem(GetParameterByName('App') + "InvoiceID"))
//        InvoiceNote = Number(localStorage.getItem(GetParameterByName('App') + "InvoiceNote"))
...
//            $('.Print_Dirct').addClass('hidden_Control')
             
//            setTimeout(function () {
//                _Print_Invoice.click();
//                $('#Back_Page').click();
//            }, 1000); 
//        }
...
//        if (_Inv.InvoiceID != null && _Inv.InvoiceID != 0) {
//            CreateBarCode(_Inv.InvoiceID) 
//        }
         
//    }


//    function CreateBarCode(InvoiceID: number) {


//        setTimeout(function () {

//            $('#numberInput').val(InvoiceID);
//            $('#btnBarcode').click();
