...
//    var Invoices: Array<Vnd_Inv_SlsMan> = new Array<Vnd_Inv_SlsMan>();
...
//        ReceiptID = Number(localStorage.getItem(GetParameterByName('App') + "ReceiptID"))
//        ReceiptNote = Number(localStorage.getItem(GetParameterByName('App') + "ReceiptNote"))


//        _Rec = _Receipt.filter(x => x.ReceiptID == ReceiptID)[0]


//        //Invoices = GetGlopelDataInvoice();
...
//        Create_Recoice_Invoices_Print();
//    }

//    function Create_Recoice_Invoices_Print() {
...
//                           <td>${Invoices[i].RefNO} </td>                                                                 
//                           <td>${Invoices[i].ItemCount} </td>                                                                    
//                           <td>${_Rec.TrType == 3 ? Invoices[i].TotalAmount : Invoices[i].NetAfterVat} </td>                                                                 
//                        </tr>`

//            $('#Body_Inv_Print').append(Row);
//        }

//        $('#Txt_CountInvoices').html((Invoices.length + 1).toString());
                                                         
//        if (Invoices.length == 0) {
//            $('._Invoices').addClass("display_none")
//        }
//		else {
//            $('._Invoices').removeClass("display_none")
