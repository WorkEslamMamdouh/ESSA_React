...
namespace Items {
	...
	var btnItemTaxEG: HTMLButtonElement;
	...
	function DisplayDataUpdate() {
		...
		let data: IQ_ViewItems = GetModelGlopel();
	...
	function InitalizeControls() {
		...
		ItemImage = document.getElementById('ItemImage') as HTMLButtonElement;
		...
		ItemFamilyID = document.getElementById('ItemFamilyID') as HTMLSelectElement;
		ISItem = document.getElementById('ISItem') as HTMLInputElement;
		IsService = document.getElementById('IsService') as HTMLInputElement;
		btnItemTaxEG = document.getElementById('btnItemTaxEG') as HTMLButtonElement;
	...
	function Assign() {
		...
		ModelDetails = new Array<D_I_ItemUnits>();
