...
class _BaseResponse {
    public static _BaseResponse: BaseResponse;
}

class ResultTable {
    
    public static ResReturn: any;
    public static ResQuery: any;
}
...
class SelectPageNumber {
    ...
    public static SearchPageNumber: number;
}

class ModelSearch {
    public static ModelMaster: any;
    public static ModelDetail: Array<any>;
}
...
class SharedWork {
    ...
    public static get PageIndex(): number {
        ...
        let value2: number = Number(localStorage.getItem(GetParameterByName('App') + "PageIndex")); //this.GetClientSession<number>("PageIndex");
        return value2;
    }
    ...
    public static get ModelCount(): number {
        if (localStorage.getItem(GetParameterByName('App') + "TableName") != null) {
            ...
            let _Table: string = localStorage.getItem(GetParameterByName('App') + "TableName");
            let _Cond: string = localStorage.getItem(GetParameterByName('App') + "ModelCount");
...
class SystemSession {
    public CurrentPrivileges: IQ_G_RoleModule = new IQ_G_RoleModule();
...
function GetSystemEnvironment(): SystemEnvironment {
    if (document.cookie.length > 0) {
        let sys: SystemEnvironment = JSON.parse(getCookie("AlAlamya_systemProperties")) as SystemEnvironment;
        //sys.CompanyNameAr = "";
        //sys.CompanyName = "";
...
function GetSystemSession(): SystemSession {
    CleaningList_Table();
    var SysSession = new SystemSession;
    SysSession.CurrentEnvironment = JSON.parse(readCookie("AlAlamya_systemProperties")) as SystemEnvironment;
...
function GetYearSession(): SystemSession {
    CleaningList_Table();
    var SysSession = new SystemSession;
    SysSession.CurrentEnvironment = JSON.parse(readCookie("AlAlamya_systemProperties")) as SystemEnvironment;
